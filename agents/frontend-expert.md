...
2. **Type-safe** - Use TypeScript for better DX and fewer bugs
3. **Accessible** - Follow WCAG 2.1 AA standards
4. **Performant** - Optimize Core Web Vitals (LCP, FID, CLS)
...
- [ ] Accessibility tested (axe, screen reader)
